...
// Retrieve the id parameter from the current request context, then convert it to an int64
// and return it. If the id parameter is missing or cannot be converted to an integer, return
// 0 and an error.
...
func (app *application) readJSON(w http.ResponseWriter, r *http.Request, dst interface{}) error {
	...
	if err != nil {
		...
		case errors.Is(err, io.ErrUnexpectedEOF):
			return errors.New("body contains incomplete JSON data")
